...
class Method_Classification_LSTM(method, nn.Module):
    ...
    def __init__(self, mName, mDescription, save_dir, vocab_size: int, embedding_size: int, hidden_size: int, num_gru_layers:int,  output_size: int,
        ...
        # GRU
        self.rnn = nn.GRU(embedding_size, hidden_size, num_layers=num_gru_layers, dropout=0.35, batch_first=True,
                           bidirectional=True)
