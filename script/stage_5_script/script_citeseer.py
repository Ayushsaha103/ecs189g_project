...
data_path = "../../data/stage_5_data/citeseer"

# Load data using load_data method
data_obj = Dataset_Loader('citeseer', '')  # Adjust for Citeseer
data_obj.dataset_source_folder_path = os.path.join(args.data_folder, 'citeseer')
...
# Model and optimizer
model = GCN_citeseer(nfeat=features.shape[1],  # Adjust for Citeseer
                     nhid=args.hidden,
