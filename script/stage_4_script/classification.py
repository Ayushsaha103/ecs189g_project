...
#from code.stage_4_code.Method_Classification_GRU import Method_Classification_GRU
...
# method_lstm_obj = Method_Classification_LSTM("Classification LSTM", '', result_obj.result_destination_folder_path, vocab_size, embedding_size, hidden_size, num_rnn_layers, output_size, learning_rate, batch_size, loss_function, optimizer, max_epochs, text_length=text_length)
# method_gru_obj = Method_Classification_GRU("Classification GRU", '', result_obj.result_destination_folder_path, vocab_size, embedding_size, hidden_size, num_rnn_layers, output_size, learning_rate, batch_size, loss_function, optimizer, max_epochs, text_length=text_length)
...
# setting_obj.prepare(data_obj, method_lstm_obj, result_obj, evaluate_obj)
# setting_obj.prepare(data_obj, method_gru_obj, result_obj, evaluate_obj)
